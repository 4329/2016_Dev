...
std::shared_ptr<Solenoid> RobotMap::stabilizerSolenoid;
std::shared_ptr<DoubleSolenoid> RobotMap::pivotDblSolenoid;
...
void RobotMap::init() {
    ...
    scalerScalerDblSolenoid.reset(new DoubleSolenoid(Preferences::GetInstance()->GetInt("Scaler::Scaler::PCMID",0),
    		Preferences::GetInstance()->GetInt("Scaler::Scaler::ForwardChannel",7),
			Preferences::GetInstance()->GetInt("Scaler::Scaler::BackwardChannel",8)));
    ...
    stabilizerSolenoid.reset(new Solenoid(Preferences::GetInstance()->GetInt("Stabilizer::PCMID",0),
    		Preferences::GetInstance()->GetInt("Stabilizer::Channel",5)));

    lw->AddActuator("Stabilizer", "StabilizerSolenoid", stabilizerSolenoid);

    pivotDblSolenoid.reset(new DoubleSolenoid(Preferences::GetInstance()->GetInt("Pivot::PCMID",0),
    		Preferences::GetInstance()->GetInt("Pivot::ForwardChannel",0),
			Preferences::GetInstance()->GetInt("Pivot::BackwardChannel",1)));
