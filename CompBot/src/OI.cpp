...
#include "Commands/Disable_Front.h"
#include "Commands/Disable_Shooter.h"
...
OI::OI() : Configurable("OI") {
    ...
    SmartDashboard::PutData("Disable_FrontIR", new Disable_Front());
    SmartDashboard::PutData("Disable_ShooterIR", new Disable_Shooter());
