...
{
	printf("Reading Autonomous Config.\n");
...
{
	printf("Saving Autonomous Config.\n");
...
void Robot_Config::Read_SensorCfg()
{
	...
	_SensorCfg.Tower_distThreshold = Preferences::GetInstance()->GetFloat("Sensor::Tower::DistThreshold",1.5);
...
void Robot_Config::Read_StabilizerCfg()
{
	...
	_StabilizerCfg.ForwardIsDeployed = Preferences::GetInstance()->GetBoolean("Stabilizer::ForwardIsDeployed",false);
}
