...
void Scaler::CreateConfig()
{
	...
	Preferences::GetInstance()->PutInt("Scalar::Stage1::Channel",0);
	Preferences::GetInstance()->PutInt("Scalar::Stage2::Channel",1);
	Preferences::GetInstance()->PutBoolean("Scalar::Stage1::ActiveIsExtended",true);
	Preferences::GetInstance()->PutBoolean("Scalar::Stage::ActiveIsExtended",true);
}
