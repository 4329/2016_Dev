...
void DriveTrain::RetrieveConfig()
{
	...
	myConfig->DriveTrain_RightTalon1_HasSensor = Preferences::GetInstance()->GetBoolean("DriveTrain::RightTalon1::HasSensor",false);
	...
	myConfig->DriveTrain_RightTalon1_EnablePID = Preferences::GetInstance()->GetBoolean("DriveTrain::RightTalon1::EnablePID",false);
	...
	myConfig->DriveTrain_LeftTalon1_HasSensor = Preferences::GetInstance()->GetBoolean("DriveTrain::LeftTalon1::HasSensor",false);
	myConfig->DriveTrain_LeftTalon1_SensorReversed = Preferences::GetInstance()->GetBoolean("DriveTrain::LeftTalon1::SensorReversed",false);
	myConfig->DriveTrain_LeftTalon1_EnablePID = Preferences::GetInstance()->GetBoolean("DriveTrain::LeftTalon1::EnablePID",false);
...
void DriveTrain::CreateConfig()
{
	...
	Preferences::GetInstance()->GetBoolean("DriveTrain::RightTalon1::HasSensor",false);
	Preferences::GetInstance()->GetBoolean("DriveTrain::RightTalon1::SensorReversed",false);
	Preferences::GetInstance()->GetBoolean("DriveTrain::RightTalon1::EnablePID",false);
    ...
    Preferences::GetInstance()->GetBoolean("DriveTrain::RightTalon2::Slaved",false);
    Preferences::GetInstance()->GetInt("DriveTrain::RightTalon2::MasterCANID",0);
	...
	Preferences::GetInstance()->GetBoolean("DriveTrain::LeftTalon1::HasSensor",false);
	Preferences::GetInstance()->GetBoolean("DriveTrain::LeftTalon1::SensorReversed",false);
	Preferences::GetInstance()->GetBoolean("DriveTrain::LeftTalon1::EnablePID",false);
	...
	Preferences::GetInstance()->GetBoolean("DriveTrain::LeftTalon2::EnablePID",false);
    ...
    Preferences::GetInstance()->GetBoolean("DriveTrain::LeftTalon2::Slaved",false);
    Preferences::GetInstance()->GetInt("DriveTrain::LeftTalon2::MasterCANID",0);
