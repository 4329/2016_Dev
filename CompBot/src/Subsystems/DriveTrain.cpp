...
void DriveTrain::RetrieveConfig()
{
	...
	myConfig->DriveTrain_LeftTalon1_Reversed = Preferences::GetInstance()->GetBoolean("DriveTrain::LeftTalon1::Reversed",false);
	...
	myConfig->DriveTrain_LeftTalon2_Reversed = Preferences::GetInstance()->GetBoolean("DriveTrain::LeftTalon2::Reversed",false);
