...
void Intake::RetrieveConfig()
{
    ...
    myConfig->Intake_Pivot_Error = Preferences::GetInstance()->GetFloat("Intake::Intake_Pivot_Error",5.0);
	...
	myConfig->Intake_pivotTalon_Profile_0_PID_P = Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::0::PID::P",0.2);
	myConfig->Intake_pivotTalon_Profile_0_PID_I = Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::0::PID::I",0.0);
	myConfig->Intake_pivotTalon_Profile_0_PID_D = Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::0::PID::D",0.0);
	myConfig->Intake_pivotTalon_Profile_0_PID_F = Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::0::PID::F",0.0);
	...
	myConfig->Intake_pivotTalon_Profile_1_PID_P = Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::1::PID::P",0.2);
	myConfig->Intake_pivotTalon_Profile_1_PID_I = Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::1::PID::I",0.0);
	myConfig->Intake_pivotTalon_Profile_1_PID_D = Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::1::PID::D",0);
	myConfig->Intake_pivotTalon_Profile_1_PID_F = Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::1::PID::F",0.0);
...
void Intake::SaveConfig()
{
    ...
    Preferences::GetInstance()->PutFloat("Intake::Intake_Pivot_Error",myConfig->Intake_Pivot_Error);
...
void Intake::CreateConfig()
{
    ...
    Preferences::GetInstance()->GetFloat("Intake::Intake_Pivot_Error",5.0);
	...
	Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::0::PID::P",0.2);
	Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::0::PID::I",0.0);
	Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::0::PID::D",0.0);
	Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::0::PID::F",0.0);
	...
	Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::1::PID::P",0.2);
	Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::1::PID::I",0.0);
	Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::1::PID::D",0);
	Preferences::GetInstance()->GetDouble("Intake::pivotTalon::Profile::1::PID::F",0.0);
...
void Intake::SetIntake(bool in, float percent_speed)
{
	if (in)
	{
		intakeTalon1->Set(myConfig->Intake_InSpeed * percent_speed);
	} else
	{
		intakeTalon1->Set(myConfig->Intake_OutSpeed * percent_speed);
	}
}
...
{
	int pos = pivotTalon->GetPosition();
	if ((pos - home) <= myConfig->Intake_Pivot_Error)
	{
		Robot::brake->Engage();
		return true;
	}
...
void Intake::SetPivotIntake()
{
	...
	{
		Robot::brake->Release();
		int pos = homeSet + myConfig->Intake_IntakeOffset;
		printf("Setting Pivot to intake position %d\n",pos);
		pivotTalon->Set(pos);
	}
}
...
{
	int bintake = homeSet + myConfig->Intake_IntakeOffset;
	int pos = pivotTalon->GetPosition();
	if (abs(pos - bintake) <= myConfig->Intake_Pivot_Error)
	{
		Robot::brake->Engage();
		printf("Pivot at intake position %d\n",abs(pos - bintake));
		return true;
	}
	printf("Pivot not at intake position %d\n",abs(pos - bintake));
	return false;
}
...
void Intake::SetPivotLow()
{
	...
	{
		Robot::brake->Release();
		int low = homeSet + myConfig->Intake_LowOffset;
		printf("Setting Pivot to Low %d\n",low);
		pivotTalon->Set(low);
	}
}
...
bool Intake::IsPivotAtLow()
{
	int low = homeSet + myConfig->Intake_LowOffset;
	int pos = pivotTalon->GetPosition();
	if (abs(pos - low) <= myConfig->Intake_Pivot_Error)
	{
		Robot::brake->Engage();
		return true;
	}
