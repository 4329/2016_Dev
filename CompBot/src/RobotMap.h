...
public:
	...
	static std::shared_ptr<CANTalon> intakeIntakeTalon1;
	static std::shared_ptr<CANTalon> intakePivotTalon;
	static std::shared_ptr<CANTalon> shooterTalon1;
	static std::shared_ptr<CANTalon> shooterTalon2;
	static std::shared_ptr<DoubleSolenoid> scalerScalerDblSolenoid;
	static std::shared_ptr<PowerDistributionPanel> pDPPowerDistributionPanel;
	// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

	static std::shared_ptr<DoubleSolenoid> scalerLiftDblSolenoid;

	static std::shared_ptr<Solenoid> brakeSolenoid;
	static std::shared_ptr<Solenoid> stabilizerSolenoid;
	static std::shared_ptr<DoubleSolenoid> pivotDblSolenoid;
